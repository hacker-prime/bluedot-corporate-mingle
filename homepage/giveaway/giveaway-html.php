            ...
            <form class="contactform" id="giveawayform" action="" method="post">
                ...
                <fieldset>
                    <div class="giveawaybutton">
                        <button type="submit" id="giveaway-submit" data-submit="...Sending">Send</button>
                    </div>
                </fieldset>
...
<!-- The ability to get quantitative data from at least 100 respondents after a single work week. -->